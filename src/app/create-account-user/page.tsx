// src/app/create-account-user/page.tsx
    ...
    <div className="flex min-h-screen items-center justify-center bg-[#001C22]">
      <Card className="w-[456px] h-[455px] flex flex-col justify-center p-4 border border-[#0A3D44] rounded-lg shadow-[0_4px_5px_rgba(0,0,0,0.25)] bg-[#001C22]">
        <CardHeader className="space-y-1">
          <CardTitle className="text-[24px] font-semibold leading-[32px] text-[#F3F4F6]">Create an account</CardTitle>
          <p className="text-sm text-[#F3F4F6]">Want to sign up as an educator? <Link href="/create-account-educator" className="underline">Click here.</Link></p>
        </CardHeader>
